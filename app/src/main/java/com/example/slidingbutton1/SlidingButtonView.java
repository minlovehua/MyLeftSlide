...
public class SlidingButtonView extends HorizontalScrollView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!once) {
            mTextView_Delete = (TextView) findViewById(com.example.slidingbutton1.R.id.tv_delete);
            mTextView_Set = (TextView) findViewById(com.example.slidingbutton1.R.id.tv_set);
            once = true;
        }
    }
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        /**
         * setTranslationX() 设置按钮的x坐标偏移量
         * 同时运行1,2,左滑不显示任何按钮。只能运行其中一个，且只显示相对的那个按钮。
         * 怎么使下面两句各自的效果同时实现?
         * 1.mTextView_Set.setTranslationX(1-mScrollWidth);
         * 2.mTextView_Delete.setTranslationX(l - mTextView_Delete.getWidth());
         *
         * 解决：只需一句：mTextView_Set.setTranslationX(1);
         */
